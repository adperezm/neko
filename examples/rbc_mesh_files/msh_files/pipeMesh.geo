...
//***** Grid Paramaters
Nc=76;  // no. of nodes (=#elem+1) in azimuthal direction
NB=6;   // no. of elemtns adjacent to the wall
NM=41;   // no. of nodes (=#elem+1) between the near wall layer and central square part
// compression ratios over the radial lines of the mesh
compressRatio_B=0.90;  //ratio of grid compression toward the wall (<1)
compressRatio_M=0.98;  //compression ratio in the middle layer
